...
public class SimplexNoise { // Simplex noise in 2D, 3D and 4D
    ...
    private static final short originalPermuatation[] = { 151, 160, 137, 91, 90, 15, 131, 13, 201, 95, 96, 53, 194, 233,
            7, 225, 140, 36, 103, 30, 69, 142, 8, 99, 37, 240, 21, 10, 23, 190, 6, 148, 247, 120, 234, 75, 0, 26, 197,
            62, 94, 252, 219, 203, 117, 35, 11, 32, 57, 177, 33, 88, 237, 149, 56, 87, 174, 20, 125, 136, 171, 168, 68,
            175, 74, 165, 71, 134, 139, 48, 27, 166, 77, 146, 158, 231, 83, 111, 229, 122, 60, 211, 133, 230, 220, 105,
    ...
    public static void regeneratePermutation(long seed) {
        Random rand = new Random();
        rand.setSeed(seed);
        for (int i = 0; i < p.length; i++) {
            p[i] = (short) rand.nextInt(256);
        }
        regenerate();
    }

    public static void restorePermuation() {
        for (int i = 0; i < SimplexNoise.originalPermuatation.length; i++) {
            p[i] = originalPermuatation[i];
        }
        regenerate();
    }
