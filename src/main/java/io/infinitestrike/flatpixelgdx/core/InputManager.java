...
public class InputManager implements InputProcessor {
    ...
    public static class InputEventManager implements InputManager.InputListener {
        ...
        @Override
        public void onInputEvent(InputManager.InputType t, InputManager m) {
    ...
    public static abstract class InputCondition{
        public abstract boolean testCondition(InputManager m, InputManager.InputType t);
    }
